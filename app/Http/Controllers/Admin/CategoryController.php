...
class CategoryController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if(!$category){
            return $this->responseRedirectBack('Error occcured while creating category.', 'error', true, true);
        }
        return $this->responseRedirectBack('admin.categories.index', 'Category added successfully', 'success', false, false);
    }
